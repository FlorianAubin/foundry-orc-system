...
export default class ORCGeneralItemSheet extends ItemSheet {
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      width: 600,
      height: 500,
      classes: ["orc", "sheet", "item", "generalitem"],
    });
  }

  get template() {
    return `systems/orc/templates/sheets/generalitem-sheet.hbs`;
  }
  ...
  getData(options) {
    ...
    if (data.item.img == "icons/svg/item-bag.svg")
      data.item.img = "icons/containers/bags/sack-canvas-grey.webp";
